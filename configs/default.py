...
cfg.dataset.train.batch_size = 6
...
cfg.model.use_audio_emb = True
# Target-pose input dimension: 12 for RWAVS, 9 for Replay-NVAS (VGGT native format)
cfg.model.pose_dim = 12
